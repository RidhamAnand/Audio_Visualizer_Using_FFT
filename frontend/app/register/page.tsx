    ...
    <main className="min-h-screen bg-black flex items-center justify-center px-4">
      ...
      >
        ...
        <div className="mb-10 text-center">
          ...
          <h1 className="text-3xl font-bold font-space-grotesk tracking-tight mb-2">Create Account</h1>
          <p className="text-white/60 text-sm">Join SonicLab and start analyzing</p>
        </div>
        ...
        <div className="rounded-lg border border-purple-900/30 bg-black/50 backdrop-blur p-7 space-y-5">
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <Input
                ...
                className="w-full h-9 rounded-md border border-purple-900/40 bg-white/5 px-3 text-white placeholder:text-white/40 focus:border-purple-500 focus:outline-none focus:ring-1 focus:ring-purple-500/20"
              />
              <p className="text-xs text-white/50 mt-1">Min 8 characters</p>
            </div>
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center">
              <span className="px-2 bg-black text-xs text-white/60">Already registered?</span>
            </div>
          </div>
